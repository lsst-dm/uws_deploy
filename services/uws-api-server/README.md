...
| butler.containerPath | string | `"/home/lsst/.lsst"` | The directory location in the container for the Butler secret |
| butler.dbUser | string | `"oods"` | Database user for Butler access |
| butler.secretKey | string | `"butler-secret"` | Secret key for the Butler secret in the Vault |
